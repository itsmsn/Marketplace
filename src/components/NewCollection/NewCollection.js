            ...
            <div className="col-11 mx-auto max-width">
              <div className="row align-content-center justify-content-between">
                <div className="col-12">
                  ...
                  {/* New Collections */}
                    <h1 className="trendingheading">{props.heading}</h1>
                    <div className="s">
                  ...
                  {/* Our new collections of digital assets related to sports, art, and entertainment are perfect for your next project. */}
